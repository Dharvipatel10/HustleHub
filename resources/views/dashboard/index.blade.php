        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <div class="flex justify-between items-center border-b-2 border-gray-200 py-2">
                ...
                <div class="flex space-x-3">
                    ...
                    class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded text-sm font-medium inline-block text-center">
                        Edit
                    </a>
                    <form method="POST" action="{{ route('jobs.destroy', $job->id) }}?from=dashboard"
                        ...
                        @method('DELETE')
                        <button type="submit"
                                class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded text-sm font-medium inline-block text-center">
                            Delete
                        </button>
                    </form>
                    <!-- End Delete Form -->
            ...
            <div class="mt-4 bg-gray-100 p-2">
                ...
                <div class="py-2">
                    ...
                    <form method="POST" action="{{ route('applicant.destroy', $applicant->id) }}"
                        onsubmit="return confirm('Are you sure that you want to delete this applicant?')">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
