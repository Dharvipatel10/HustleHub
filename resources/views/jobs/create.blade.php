        ...
        <h2 class="text-4xl text-center font-bold mb-4">
            Create Job Listing
                ...
                <form method="POST" action="/jobs" enctype="multipart/form-data">
                    ...
                    <x-inputs.text id="address" name="address" label="Address" placeholder="Wittenberger str. 5"/>

                    <x-inputs.text id="city" name="city" label="City" placeholder="Chemnitz"/>

                    <x-inputs.text id="state" name="state" label="State" placeholder="Saxony"/>

                    <x-inputs.text id="zipcode" name="zipcode" label="ZIP Code" placeholder="09126"/>
